...
public class ParameterServlet extends HttpServlet {
    ...
    public ParameterServlet() {
        super();
       System.out.println("ParameterServlet-DC");
    }
	...
	public void init() throws ServletException {
		System.out.println("ParameterServlet-init()-start");
		...
		System.out.println("ParameterServlet-init()-end");
	}
private void m2() {
...
private void m1(){
	...
	public void destroy() {
		System.out.println("ParameterServlet-destroy()");
	}

	
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("ParameterServlet-service()-begin");
		...
		pw.println("<hr/>");
		System.out.println("ParameterServlet-service() end");
	}
