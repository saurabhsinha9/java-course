 ...
 * generated in the com.jlcindia.cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetStudentResponse_QNAME = new QName("http://cxf.jlcindia.com/", "getStudentResponse");
	private final static QName _AddStudent_QNAME = new QName("http://cxf.jlcindia.com/", "addStudent");
	private final static QName _GetStudent_QNAME = new QName("http://cxf.jlcindia.com/", "getStudent");
	private final static QName _AddStudentResponse_QNAME = new QName("http://cxf.jlcindia.com/", "addStudentResponse");
	private final static QName _GetMessage_QNAME = new QName("http://cxf.jlcindia.com/", "getMessage");
    private final static QName _GetMessageResponse_QNAME = new QName("http://cxf.jlcindia.com/", "getMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jlcindia.cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "getStudentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "addStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "getStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "addStudentResponse")
     ...
     * 
     */
//    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "getMessage")
     ...
     * 
     */
//    @XmlElementDecl(namespace = "http://cxf.jlcindia.com/", name = "getMessageResponse")
