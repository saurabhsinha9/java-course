...
public interface StockQuoteSoap {
	...
	@RequestWrapper(localName = "GetQuote", targetNamespace = "http://www.webserviceX.NET/", className = "com.jlcindia.jaxws.sq.client.GetQuote")
	@ResponseWrapper(localName = "GetQuoteResponse", targetNamespace = "http://www.webserviceX.NET/", className = "com.jlcindia.jaxws.sq.client.GetQuoteResponse")
